...
- Selecting blocks with shift V and then moving them deleting them the same way as normal
    * [ ] Plus individual selection by just tapping v
- Add vim style numbered movement, e.g. 10k to jump 10 up.
